...
Create a beautiful calculator web application with basic arithmetic operations (+, -, *, /), clear and delete buttons, keyboard support, and a modern gradient design with smooth animations
